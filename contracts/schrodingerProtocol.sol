...
import "./verifierAverageDotProduct.sol";
import "./verifierWeightedAverage.sol";
import "./verifierSimple.sol";
...
contract SchrodingerProtocol {
    ...
    constructor(
        ...
        address VerifierAverageDotProductAddress,
        address VerifierWeightedAverageAddress,
        address VerifierSimpleAddress
    ) {
        _owner = msg.sender;
        ...
        _verifiers["average_dot_product"] = VerifierAverageDotProductAddress;
        _verifiers["weighted_average"] = VerifierWeightedAverageAddress;
        _verifiers["simple"] = VerifierSimpleAddress;
    }
